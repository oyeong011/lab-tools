...
| MacBook M1/M4 | planned | `apple` | Needs Metal/MPS kernels and powermetrics collection |
...
| Memory hierarchy, DRAM row policy, GPU memory controller | row-buffer activation-count papers, Warped-MC, data-cache analysis | `memory-hierarchy-pim` | planned |
| PIM, GEMV, SpMV, sparse-dense kernels | SparsePIM, GEMV GPU/PIM address mapping, HyMM, GCN aggregation | `memory-hierarchy-pim` | planned |
